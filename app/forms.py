...
class MedicalForm(FlaskForm):
    ...
    restrictions = TextAreaField('He/ She may participate in all camp activities, with the following restrictions (which parents will be responsible for discussign with camp staff/ counselor upon arrival to camp, to assure tehse restrictions are able to be met', validators=[Optional()])
    ...
    sign = StringField('Signature', render_kw={"placeholder": "Initials or full name"}, validators=[Required()])
