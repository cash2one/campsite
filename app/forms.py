...
ALLERGIES = [('None', 'None'), ('Food', 'Food'), ('Medicine', 'Medicine'), ('Environment', 'Environment'), ('Insect Bites', 'Insect Bites'), ('Other', 'Other')]
YESNO = [(1, 'Yes'),(0, 'No')]
...
class MedicalForm(FlaskForm):
    ...
    mump = DateField('Mump, measles, rubella (MMR)', format=FDATE, validators=[InputRequired()], render_kw={"placeholder": DATEPH} )
    ...
    pmed1name = StringField('Medication Name', validators=[Optional()])
    ...
    pmed2name =StringField('Medication Name', validators=[Optional()])
    ...
    pmed3name =StringField('Medication Name', validators=[Optional()])
    ...
    pmed4name = StringField('Medication Name', validators=[Optional()])
    ...
    npmed1name = StringField('Medication Name', validators=[Optional()])
    ...
    npmed2name = StringField('Medication Name', validators=[Optional()])
    ...
    npmed3name = StringField('Medication Name', validators=[Optional()])
    ...
    npmed4name = StringField('Medication Name', validators=[Optional()])
    ...
    asth = RadioField('Had asthma/ wheezing/ shortness of breath/ requires an inhaler?', coerce=int, choices=YESNO, validators=[InputRequired()])
    diab = RadioField('Have diabetes?', coerce=int, choices=YESNO, validators=[InputRequired()])
    envallg = RadioField('Had seasonal/ environmental allergies?', coerce=int, choices=YESNO, validators=[InputRequired()])
